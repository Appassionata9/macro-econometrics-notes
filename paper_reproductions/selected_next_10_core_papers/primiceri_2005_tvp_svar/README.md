...
- 新增 60、120、180 个月 rolling window 的敏感性比较。

## 数据与代码

- 数据：`../data/processed/small_macro_monthly_1960_2026.csv`
- 论文：`paper/tvsvar_final_july_04.pdf`
- 代码：`../code/run_baseline_replications.R`、`../code/run_extended_replications.R`
- 输出：`../results/rolling_policy_rule_coefficients.csv`、`../results/primiceri_rolling_window_sensitivity.csv`
