...
- 新增 direct forecast exercise，对 AR 与 AR plus diffusion factors 做 6、12、24 个月 horizon RMSE 比较。
...
- 输出：`../results/diffusion_factor_variance.csv`、`../results/stock_watson_diffusion_forecast_rmse.csv`
...
本地 FRED-MD 样本中，前三个因子累计解释约 36.9% 的 transformed panel variation，前二十个因子累计解释约 75.0%。扩展脚本还输出了 AR 与 diffusion-index forecast 的 horizon-specific RMSE。
